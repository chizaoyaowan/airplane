...
class midenemy(pygame.sprite.Sprite):
    ...
    def __init__(self,bg_size):
        ...
        self.hit_image=pygame.image.load("ui/shoot/enemy2_hit.png").convert_alpha()
        self.destroy_image = []
        self.destroy_image.extend(\
...
class bigenemy(pygame.sprite.Sprite):
    ...
    def __init__(self,bg_size):
        ...
        self.hit_image=pygame.image.load("ui/shoot/enemy3_hit.png").convert_alpha()
        self.destroy_image = []
        self.destroy_image.extend(\
        ...
        self.rect.left,self.rect.top =\
                                     randint(0,self.width -self.rect.width),\
                                     randint(-6*self.height,-1*self.height)
